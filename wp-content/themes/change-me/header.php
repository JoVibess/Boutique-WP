	...
	<header class="site-header">
		...
		<nav class="navbar navbar-expand-lg header-nav">
			<div class="container d-flex align-items-center justify-content-between">
				...
				<!-- LOGO -->
				<a class="navbar-brand fw-bold" href="<?= home_url(); ?>">CELIA</a>
				...
				<div class="header-icons d-flex align-items-center gap-3">
					...
					<a class="icon user-icon" href="<?php echo wc_get_page_permalink('myaccount'); ?>">
					...
					<a class="icon cart-icon" href="<?php echo wc_get_cart_url(); ?>">
						<svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="search-overlay" id="searchOverlay" aria-hidden="true">
			...
			<div class="search-overlay__content">
				<button class="search-overlay__close" aria-label="Fermer">
					&times;
				</button>
				...
				<form role="search"
					...
					<!-- Forcer la recherche WooCommerce -->
